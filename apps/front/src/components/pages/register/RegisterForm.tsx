...
export function RegisterForm() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    openCopyModal(buildIssueBody(payload), buildIssueTitleOnlyUrl(payload))
  }
        ...
        >
          ...
          >
            <VStack
              ...
              borderRadius={[null, null, null, '$spacingSpacing24']}
              boxShadow="$shadowShadowXs"
              overflow="hidden"
              px={['$spacingSpacing20', null, null, '$spacingSpacing48']}
              py={['$spacingSpacing24', null, null, '$spacingSpacing40']}
              w="100%"
            >
              <VStack gap={['28px', null, null, null, '46px']} w="100%">
                ...
                <Field
                  description={t.register.causeDesc}
                  label={t.register.cause}
                >
                  <Flex
                    flexWrap="wrap"
                    gap={['16px', null, null, null, '28px']}
                  >
                ...
                <Field
                  description={t.register.causeAnalysisDesc}
                  hint={t.register.optional}
                  label={t.register.causeAnalysis}
                >
                ...
                <Field
                  description={t.register.rootCausesDesc}
                  hint={t.register.optional}
                  label={t.register.rootCauses}
                >
                  <StringListSection
                    onAdd={() =>
                ...
                <Field
                  description={t.register.preventionDesc}
                  hint={t.register.optional}
                  label={t.register.prevention}
                >
                  <VStack
